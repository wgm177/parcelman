...
public class ParcelTest {
	...
	public void testCalFee() {
		...
		assertEquals(0,tp1.calculateFee(),0.1);
		assertEquals(0,tp2.calculateFee(),0.1);
		assertEquals(9.09,tp3.calculateFee(),0.1);
		assertEquals(20.4,tp4.calculateFee(),0.1);
		assertEquals(41.04,tp5.calculateFee(),0.1);
		assertEquals(45.6,tp6.calculateFee(),0.1);
		assertEquals(88.56,tp7.calculateFee(),0.1);
		assertEquals(98.4,tp8.calculateFee(),0.1);
		assertEquals(195.84,tp9.calculateFee(),0.1);
		assertEquals(217.6,tp10.calculateFee(),0.1);
		assertEquals(423.36,tp11.calculateFee(),0.1);
		assertEquals(470.4,tp12.calculateFee(),0.1);
		assertEquals(1088.64,tp13.calculateFee(),0.1);
		assertEquals(1209.6,tp14.calculateFee(),0.1);
		assertEquals(2914.56,tp15.calculateFee(),0.1);
		assertEquals(3238.4,tp16.calculateFee(),0.1);
		assertEquals(2304,tp17.calculateFee(),0.1);
		assertEquals(2560,tp18.calculateFee(),0.1);
		assertEquals(4884.48,tp19.calculateFee(),0.1);
		assertEquals(5478.4,tp20.calculateFee(),0.1);
		assertEquals(9.81,tp21.calculateFee(),0.1);
		assertEquals(10.9,tp22.calculateFee(),0.1);
		assertEquals(21.24,tp23.calculateFee(),0.1);
		assertEquals(23.6,tp24.calculateFee(),0.1);
		assertEquals(47.16,tp25.calculateFee(),0.1);
		assertEquals(52.4,tp26.calculateFee(),0.1);
		assertEquals(87.12,tp27.calculateFee(),0.1);
		assertEquals(3296,tp28.calculateFee(),0.1);
		assertEquals(128200,tp29.calculateFee(),0.1);
		assertEquals(160200,tp30.calculateFee(),0.1);
		assertEquals(3600,tp31.calculateFee(),0.1);
		assertEquals(403.2,tp32.calculateFee(),0.1);
		assertEquals(806.4,tp33.calculateFee(),0.1);
		assertEquals(10125000,tp34.calculateFee(),0.1);
		assertEquals(0,tp35.calculateFee(),0.1);
		assertEquals(0,tp36.calculateFee(),0.1);
		assertEquals(0,tp37.calculateFee(),0.1);
		assertEquals(0,tp38.calculateFee(),0.1);
		assertEquals(10,tp39.calculateFee(),0.1);
		assertEquals(0,tp40.calculateFee(),0.1);
		assertEquals(-9.8,tp41.calculateFee(),0.1);
		assertEquals(-19.4,tp42.calculateFee(),0.1);
		assertEquals(28.8,tp43.calculateFee(),0.1);
		assertEquals(47.5,tp44.calculateFee(),0.1);
		assertEquals(94,tp45.calculateFee(),0.1);
		assertEquals(558,tp46.calculateFee(),0.1);
