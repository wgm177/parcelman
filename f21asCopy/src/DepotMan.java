...
public class DepotMan {
	public static ParcelList parcelList = new ParcelList();
	...
	public boolean popCustomerList()
	{
	 ...
	 private void showGUI() {
	    	//create main GUI with CustomerList object
	    	CusomerListGUI CustomerGui = new CusomerListGUI(customerList);
	        CustomerGui.setVisible(true);
	      //create main GUI with ParcelList object
	    	ParcelListGUI ParcelGui = new ParcelListGUI(parcelList);
	        ParcelGui.setVisible(true);
